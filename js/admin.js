new Vue({
      ...
      data() {
        return {
          ...
          isEditing: false,
          columns: [
            {content: '联系方式', icon: 'icon-about', path: '#contact'},
            {content: '新闻管理', icon: 'icon-News', path: '#news'},
            {content: '历史管理', icon: 'icon-history1', path: '#history'}, 
            {content: '留言管理', icon: 'icon-diedaisanicon39', path: '#message'},     
